...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field polls on 'Article'
        db.create_table('jmboarticles_article_polls', (
        ...
        db.create_unique('jmboarticles_article_polls', ['article_id', 'poll_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field polls on 'Article'
        db.delete_table('jmboarticles_article_polls')
