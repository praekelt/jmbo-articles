...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field downloads on 'Article'
        db.create_table('jmboarticles_article_downloads', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['jmboarticles.article'], null=False)),
            ('download', models.ForeignKey(orm['downloads.download'], null=False))
        ))
        db.create_unique('jmboarticles_article_downloads', ['article_id', 'download_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field downloads on 'Article'
        db.delete_table('jmboarticles_article_downloads')
