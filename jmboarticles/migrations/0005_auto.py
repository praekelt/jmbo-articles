...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('article_article_categories', (
        ...
        db.create_unique('article_article_categories', ['article_id', 'category_id'])

        # Adding M2M table for field tags on 'Article'
        db.create_table('article_article_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm['article.article'], null=False)),
            ('tag', models.ForeignKey(orm['category.tag'], null=False))
        ))
        db.create_unique('article_article_tags', ['article_id', 'tag_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field categories on 'Article'
        db.delete_table('article_article_categories')

        # Removing M2M table for field tags on 'Article'
        db.delete_table('article_article_tags')
