...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Article.poll'
        db.delete_column('jmboarticles_article', 'poll_id')


    def backwards(self, orm):
        
        # Adding field 'Article.poll'
        db.add_column('jmboarticles_article', 'poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poll.Poll'], null=True, blank=True), keep_default=False)
