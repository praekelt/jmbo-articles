...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Article.video'
        raise RuntimeError("Cannot reverse this migration. 'Article.video' and its values cannot be restored.")
