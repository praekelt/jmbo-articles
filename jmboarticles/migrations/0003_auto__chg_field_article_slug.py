...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('article_article', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Article.slug'
        db.alter_column('article_article', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
