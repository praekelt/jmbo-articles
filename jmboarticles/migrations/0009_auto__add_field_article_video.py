...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('article_article', 'video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['video.Video'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Article.video'
        db.delete_column('article_article', 'video_id')
