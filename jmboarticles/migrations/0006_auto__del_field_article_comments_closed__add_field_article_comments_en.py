...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Article.comments_closed'
        db.delete_column('article_article', 'comments_closed')

        # Adding field 'Article.comments_enabled'
        db.add_column('article_article', 'comments_enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Article.comments_closed'
        db.add_column('article_article', 'comments_closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Article.comments_enabled'
        db.delete_column('article_article', 'comments_enabled')
