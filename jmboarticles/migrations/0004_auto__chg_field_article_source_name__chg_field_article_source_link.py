...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.source_name'
        db.alter_column('article_article', 'source_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Article.source_link'
        db.alter_column('article_article', 'source_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Article.source_name'
        db.alter_column('article_article', 'source_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Article.source_link'
        db.alter_column('article_article', 'source_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
