...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.linked_content'
        db.add_column('article_article', 'linked_content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['featured.Item'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.linked_content'
        db.delete_column('article_article', 'linked_content_id')
