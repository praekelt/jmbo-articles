...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.linked_article'
        db.add_column('article_article', 'linked_article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['article.Article'], null=True, blank=True), keep_default=False)

        # Adding field 'Article.linked_page'
        db.add_column('article_article', 'linked_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['flatpages.FlatPage'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.linked_article'
        db.delete_column('article_article', 'linked_article_id')

        # Deleting field 'Article.linked_page'
        db.delete_column('article_article', 'linked_page_id')
