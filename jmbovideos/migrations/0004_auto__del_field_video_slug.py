...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('video_video', 'slug')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Video.slug'
        raise RuntimeError("Cannot reverse this migration. 'Video.slug' and its values cannot be restored.")
