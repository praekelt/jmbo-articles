...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('video_video', 'video_file')

        # Adding field 'Video.video'
        db.add_column('video_video', 'video', self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('video_video', 'video')
